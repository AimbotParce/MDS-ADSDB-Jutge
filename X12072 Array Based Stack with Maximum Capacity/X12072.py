...
class BaseArrayStack:
    ...
    def push(self, e):
        ...
        BaseArrayStack._resize_check(previous, current)
...
class FixedSizeArrayStack(BaseArrayStack):
...
def ArrayStack(maxlen: int = 0):
    ...
    """
    if maxlen >= 0:
        return FixedSizeArrayStack(maxlen=maxlen)
    else:
        return BaseArrayStack()
